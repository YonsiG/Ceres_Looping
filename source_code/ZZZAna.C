...
/************reconstructions***************/
   ...
   ZZZ = lepZ+trueFatJets->at(0)+trueFatJets->at(1);
   ...
   myHists->fatjetMass_Pt_sub->Fill(trueFatJetMass->at(1),trueFatJetPt->at(1),weight);
   myHists->fatjetMass_tau21_lead->Fill(trueFatJetMass->at(0),trueFatJetTau21->at(0),weight);
   myHists->fatjetMass_tau21_sub->Fill(trueFatJetMass->at(1),trueFatJetTau21->at(1),weight);
   myHists->fatjettau21_Pt_lead->Fill(trueFatJetTau21->at(0),trueFatJetPt->at(0),weight);
   myHists->fatjettau21_Pt_sub->Fill(trueFatJetTau21->at(1),trueFatJetPt->at(1),weight);
   ...
   myHists->ZZZMass_fatjetMass_sub->Fill(ZZZ.M(),trueFatJetMass->at(1),weight);
   myHists->ZZZMass_fatjetPt_sub->Fill(ZZZ.M(),trueFatJetPt->at(1),weight);
   myHists->ZZZMass_fatjettau21_sub->Fill(ZZZ.M(),trueFatJetTau21->at(1),weight);
...
//   myHists->ZZZ_mass->Fill(ZZZ.M(),weight);
   ...
   myHists->fatjetMass_sub->Fill(trueFatJetMass->at(1),weight);
   myHists->fatjet_tau21_sub->Fill(trueFatJetTau21->at(1),weight);
   myHists->fatjet_pt_sub->Fill(trueFatJetPt->at(1),weight);
   ...
   if ((trueLeptonsID->at(0)*trueLeptonsID->at(1))==-121)
    {
     ...
     myHists->fatjetMass_ee_sub->Fill(trueFatJetMass->at(1),weight);
     myHists->fatjet_tau21_ee_sub->Fill(trueFatJetTau21->at(1),weight);
     myHists->fatjet_pt_ee_sub->Fill(trueFatJetPt->at(1),weight);

     myHists->leptonPt_ee_lead->Fill(trueLeptonsPt->at(0),weight);
     myHists->leptonEta_ee_lead->Fill(trueLeptonsEta->at(0),weight);
     myHists->leptonPhi_ee_lead->Fill(trueLeptonsPhi->at(0),weight);
     myHists->leptonPt_ee_sub->Fill(trueLeptonsPt->at(1),weight);
     myHists->leptonEta_ee_sub->Fill(trueLeptonsEta->at(1),weight);
     myHists->leptonPhi_ee_sub->Fill(trueLeptonsPhi->at(1),weight);
    }
   ...
   if ((trueLeptonsID->at(0)*trueLeptonsID->at(1))==-169)
    {
     ...
     myHists->fatjetMass_mm_sub->Fill(trueFatJetMass->at(1),weight);
     myHists->fatjet_tau21_mm_sub->Fill(trueFatJetTau21->at(1),weight);
     myHists->fatjet_pt_mm_sub->Fill(trueFatJetPt->at(1),weight);

     myHists->leptonPt_mm_lead->Fill(trueLeptonsPt->at(0),weight);
     myHists->leptonEta_mm_lead->Fill(trueLeptonsEta->at(0),weight);
     myHists->leptonPhi_mm_lead->Fill(trueLeptonsPhi->at(0),weight);
     myHists->leptonPt_mm_sub->Fill(trueLeptonsPt->at(1),weight);
     myHists->leptonEta_mm_sub->Fill(trueLeptonsEta->at(1),weight);
     myHists->leptonPhi_mm_sub->Fill(trueLeptonsPhi->at(1),weight);
    }
   ...
   if ((trueLeptonsID->at(0)*trueLeptonsID->at(1))==-143)
    {
     ...
     myHists->fatjetMass_em_sub->Fill(trueFatJetMass->at(1),weight);
     myHists->fatjet_tau21_em_sub->Fill(trueFatJetTau21->at(1),weight);
     myHists->fatjet_pt_em_sub->Fill(trueFatJetPt->at(1),weight);

     myHists->leptonPt_em_lead->Fill(trueLeptonsPt->at(0),weight);
     myHists->leptonEta_em_lead->Fill(trueLeptonsEta->at(0),weight);
     myHists->leptonPhi_em_lead->Fill(trueLeptonsPhi->at(0),weight);
     myHists->leptonPt_em_sub->Fill(trueLeptonsPt->at(1),weight);
     myHists->leptonEta_em_sub->Fill(trueLeptonsEta->at(1),weight);
     myHists->leptonPhi_em_sub->Fill(trueLeptonsPhi->at(1),weight);
    }
