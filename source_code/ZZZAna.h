...
class ZZZAna
{
 ...
 std::vector<double>*               J_eta=0;
 std::vector<double>*               lep_pt=0;
 std::vector<double>*               lep_eta=0;
 std::vector<double>*               lep_phi=0;
 std::vector<double>*               lep_relIso03EA=0;
 std::vector<double>*               lep_relIso04DB=0;
 std::vector<double>*               lep_isMediumPOG=0;
...
void ZZZAna::Initial(const char* rootName, int rootNumber)
{
 ...
 TH1D *hevts = (TH1D *)file->Get("h_neventsinfile");
 evtsInFiles += hevts->GetBinContent(16);
 ...
 fChain->SetBranchAddress("lep_relIso04DB",&lep_relIso04DB);
...
void ZZZAna::Save(int rootNumber)
{
 ...
 cout<<"events in files: "<<evtsInFiles<<endl;
